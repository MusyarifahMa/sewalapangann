    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (_) =>
                CategoryScreen(title: title, images: lapanganImages),
          ),
        );
      },
      child: Stack(
              ...
              return GridView.count(
                ...
                children: [
                  _sportCard(
                    ...
                    lapanganImages: [
                      'assets/images/bd1.jpeg',
                      'assets/images/bd2.jpg',
                      'assets/images/bd3.jpg',
                      'assets/images/bd4.jpg',
                      'assets/images/bd5.jpg',
                      'assets/images/bd6.jpg',
                    ],
                  ),
                  _sportCard(
                    context: context,
